...
namespace LCTMoodle.LCTView
{
    ...
    {
        public static HtmlString link(HoatDongDTO hoatDong, int? maNguoiDung = null, Dictionary<string, string> thamSo = null)
        {
        ...
        public static string text(HoatDongDTO hoatDong, int? maNguoiDung = null, Dictionary<string, string> thamSo = null)
        {
            if (hoatDong == null || hoatDong.hanhDong == null)
            {
                return null;
